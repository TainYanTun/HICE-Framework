...
\]
This composite metric identifies the \textbf{Sagaing Region} as the most critical "Red Zone" for health assistance, while also highlighting elevated vulnerability in \textbf{Kayah} and \textbf{Rakhine}. As previously illustrated in the Regional Severity Assessment (Fig. \ref{fig:severity_assessment}), the quadrant-based view (Event Frequency vs. Lethality) distinguishes high-frequency conflict zones from high-lethality areas, supporting the evidence-based prioritization of humanitarian medical resources.
